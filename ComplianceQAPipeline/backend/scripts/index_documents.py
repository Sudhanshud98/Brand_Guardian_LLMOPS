...
def index_docs():
    '''
    Reads the PDF, chuck them, and upload them toAzure AI Search
    '''
    ...
    if missing_vars :
        logger.error(f"Missing required evironen variales : {missing_vars}")
    ...
    try:
        ...
        logger.info(f"Vectore Store initialized for index : {index_name}")
